...
var SDK = /** @class */ (function () {
    function SDK(options) {
        ...
        /* istanbul ignore next */
        this.delete = function (url, body, query, options) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, this.platform().send(__assign({ method: 'DELETE', url: url, query: query, body: body }, options))];
        }); }); };
        /* istanbul ignore next */
