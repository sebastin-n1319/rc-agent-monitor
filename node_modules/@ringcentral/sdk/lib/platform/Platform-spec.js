...
describe('RingCentral.platform.Platform', function () {
    ...
    describe('get, post, put, patch, delete', function () {
        ...
        it('DELETE without body', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            var platform, client, path, request, res, json;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        platform = sdk.platform();
                        client = sdk.client();
                        path = "/restapi/v1.0/foo/delete-no-body";
                        (0, test_1.apiCall)('DELETE', path, { ok: true });
                        client.on(client.events.requestSuccess, function (_, r) {
                            request = r;
                        });
                        return [4 /*yield*/, platform.delete(path)];
                    case 1:
                        res = _a.sent();
                        return [4 /*yield*/, res.json()];
                    case 2:
                        json = _a.sent();
                        (0, test_1.expect)(json.ok).toEqual(true);
                        (0, test_1.expect)(request.method).toEqual('DELETE');
                        (0, test_1.expect)(request.url).toEqual("http://whatever".concat(path));
                        (0, test_1.expect)(request.headers.get('content-type')).toContain('application/json');
                        (0, test_1.expect)(request['originalBody']).toEqual(undefined);
                        return [2 /*return*/];
                }
            });
        }); }));
        it('DELETE with JSON body', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            var platform, client, path, request, payload, res, json;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        platform = sdk.platform();
                        client = sdk.client();
                        path = "/restapi/v1.0/foo/delete-with-body";
                        (0, test_1.apiCall)('DELETE', path, { ok: true });
                        client.on(client.events.requestSuccess, function (_, r) {
                            request = r;
                        });
                        payload = { reason: 'cleanup', force: true };
                        return [4 /*yield*/, platform.delete(path, payload)];
                    case 1:
                        res = _a.sent();
                        return [4 /*yield*/, res.json()];
                    case 2:
                        ...
                        (0, test_1.expect)(request.url).toEqual("http://whatever".concat(path));
                        (0, test_1.expect)(request.headers.get('content-type')).toContain('application/json');
                        (0, test_1.expect)(request['originalBody']).toEqual(JSON.stringify(payload));
                        return [2 /*return*/];
                }
            });
        }); }));
