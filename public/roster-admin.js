...
/* === BULK ACTION BAR === */
#roster-admin-root .rx-bulk-bar { background: #1A1D21 !important; border-radius: 16px !important; padding: 10px 14px !important; box-shadow: 0 18px 48px rgba(16,24,40,.18) !important; align-items: center !important; gap: 12px !important; flex-wrap: nowrap !important; min-height: 48px !important; border: none !important; } #roster-admin-root .rx-bulk-bar[style*="display: flex"], #roster-admin-root .rx-bulk-bar[style*="display:flex"] { display: flex !important; }
