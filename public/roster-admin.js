...
#roster-admin-root .rx-kpis { display: grid !important; grid-template-columns: repeat(5,1fr) !important; gap: 8px !important; margin-bottom: 2px !important; }
...
#roster-admin-root .rx-kpi-icon { width: 32px !important; height: 32px !important; min-width: 32px !important; border-radius: 9px !important; display: flex !important; align-items: center !important; justify-content: center !important; background: #F9FAFB !important; flex-shrink: 0 !important; }
#roster-admin-root .rx-kpi-text { flex: 1 !important; min-width: 0 !important; }
#roster-admin-root .rx-kpi-lbl { font-size: 10px !important; font-weight: 600 !important; color: #9AA3AF !important; letter-spacing: .04em !important; text-transform: uppercase !important; margin: 0 0 2px !important; }
#roster-admin-root .rx-kpi-val { font-size: 20px !important; font-weight: 700 !important; letter-spacing: -0.03em !important; color: #1A1D21 !important; line-height: 1 !important; margin: 0 0 3px !important; }
#roster-admin-root .rx-kpi-sub { font-size: 10px !important; color: #9AA3AF !important; font-weight: 400 !important; margin-top: 1px !important; white-space: nowrap !important; overflow: hidden !important; text-overflow: ellipsis !important; }
#roster-admin-root .rx-kpi-bar { height: 4px !important; border-radius: 99px !important; background: #EEF0F3 !important; margin-top: 8px !important; overflow: hidden !important; }
#roster-admin-root .rx-kpi-bar-fill { height: 100% !important; border-radius: 99px !important; background: linear-gradient(90deg,#F59E0B,#F97316) !important; }
...
#roster-admin-root .rx-toolbar { display: flex !important; align-items: center !important; gap: 8px !important; flex-wrap: wrap !important; background: #fff !important; border: 1px solid #E8EAED !important; border-radius: 12px !important; padding: 8px 12px !important; box-shadow: 0 1px 3px rgba(16,24,40,.04) !important; margin-bottom: 2px !important; }
#roster-admin-root .rx-month-display { display: flex !important; align-items: center !important; position: relative !important; }
#roster-admin-root .rx-month-display span { font-size: 13px !important; font-weight: 600 !important; min-width: 90px !important; text-align: center !important; letter-spacing: -0.01em !important; color: #1A1D21 !important; }
...
#roster-admin-root .rx-icon-btn { width: 28px !important; height: 28px !important; border-radius: 8px !important; border: 1px solid #E8EAED !important; background: #fff !important; color: #9AA3AF !important; cursor: pointer !important; display: grid !important; place-items: center !important; font-size: 13px !important; transition: all .15s !important; flex-shrink: 0 !important; }
#roster-admin-root .rx-icon-btn:hover { background: #FFF3EA !important; border-color: #F97316 !important; color: #F97316 !important; }
#roster-admin-root .rx-pill { height: 28px !important; padding: 0 10px !important; border-radius: 8px !important; border: 1px solid #E8EAED !important; background: #fff !important; color: #5B6470 !important; font-family: 'Poppins',sans-serif !important; font-size: 12px !important; font-weight: 500 !important; cursor: pointer !important; display: inline-flex !important; align-items: center !important; gap: 5px !important; transition: all .12s !important; white-space: nowrap !important; }
...
#roster-admin-root .rx-search { display: flex !important; align-items: center !important; gap: 7px !important; height: 28px !important; padding: 0 10px !important; border: 1px solid #E8EAED !important; border-radius: 8px !important; background: #fff !important; flex: 1 !important; min-width: 160px !important; }
#roster-admin-root .rx-search input { border: none !important; outline: none !important; font-family: 'Poppins',sans-serif !important; font-size: 12px !important; width: 100% !important; color: #1A1D21 !important; background: transparent !important; }
#roster-admin-root .rx-search input::placeholder { color: #B0B8C4 !important; }
#roster-admin-root .rx-switch { display: inline-flex !important; align-items: center !important; gap: 5px !important; font-size: 11.5px !important; color: #5B6470 !important; cursor: pointer !important; padding: 4px 8px !important; background: #F6F7F9 !important; border-radius: 99px !important; border: 1px solid #E8EAED !important; user-select: none !important; }
...
#roster-admin-root .rx-filter-bar { display: flex !important; align-items: center !important; gap: 0 !important; padding: 6px 12px !important; background: #fff !important; border: 1px solid #E8EAED !important; border-radius: 12px !important; flex-wrap: wrap !important; row-gap: 4px !important; margin-bottom: 2px !important; }
...
#roster-admin-root .rx-filter-chip { display: inline-flex !important; align-items: center !important; gap: 4px !important; padding: 2px 9px !important; border-radius: 99px !important; font-size: 11px !important; font-weight: 500 !important; border: 1.5px solid transparent !important; background: #F1F2F4 !important; color: #5B6470 !important; cursor: pointer !important; transition: all .1s !important; font-family: 'Poppins',sans-serif !important; }
...
/* === VIEW TABS — compact === */
#roster-admin-root .rx-view-tabs { display: flex !important; align-items: center !important; gap: 6px !important; margin-bottom: 2px !important; }
...
#roster-admin-root .rx-bulk-count { color: #fff !important; font-size: 11.5px !important; font-weight: 600 !important; white-space: nowrap !important; background: rgba(255,255,255,.1) !important; padding: 3px 10px !important; border-radius: 20px !important; border: 1px solid rgba(255,255,255,.15) !important; }
#roster-admin-root .rx-bulk-sel { height: 28px !important; font-size: 11.5px !important; padding: 0 8px !important; border-radius: 7px !important; border: 1px solid rgba(255,255,255,.2) !important; background: rgba(255,255,255,.07) !important; color: #fff !important; font-family: 'Poppins',sans-serif !important; }
#roster-admin-root .rx-bulk-date { height: 28px !important; font-size: 11.5px !important; padding: 0 8px !important; border-radius: 7px !important; border: 1px solid rgba(255,255,255,.2) !important; background: rgba(255,255,255,.07) !important; color: #fff !important; max-width: 130px !important; font-family: 'Poppins',sans-serif !important; }
#roster-admin-root .rx-bulk-btn { height: 28px !important; padding: 0 12px !important; border-radius: 7px !important; border: 1px solid rgba(255,255,255,.2) !important; background: rgba(255,255,255,.1) !important; color: #fff !important; font-size: 11.5px !important; font-weight: 600 !important; cursor: pointer !important; font-family: 'Poppins',sans-serif !important; white-space: nowrap !important; }
