...
(function () {
  ...
  (function injectCSS() {
    ...
    s.textContent = `
/* ═══════════════════════════════════════════════════════════════
   ADIT ROSTER — WORLD-CLASS DESIGN v4.0
═══════════════════════════════════════════════════════════════ */
:root {
  --rx-bg: #F4F6FA;
  --rx-surface: #FFFFFF;
  ...
  --rx-ink4: #CBD5E1;
  --rx-accent: #F97316;
  --rx-accent-light: rgba(249,115,22,.10);
  --rx-accent-glow: rgba(249,115,22,.22);
  --rx-weekend: #FAFBFF;
  --rx-green: #059669;
  --rx-navy: #1E293B;
  --rx-shadow-xs: 0 1px 2px rgba(15,23,42,.06);
  --rx-shadow-sm: 0 1px 4px rgba(15,23,42,.08), 0 0 0 1px rgba(15,23,42,.04);
  --rx-shadow-md: 0 4px 16px rgba(15,23,42,.10), 0 1px 4px rgba(15,23,42,.06);
  --rx-shadow-lg: 0 12px 40px rgba(15,23,42,.14), 0 2px 8px rgba(15,23,42,.08);
  --rx-radius: 14px;
  --rx-radius-sm: 8px;
  --rx-row-h: 46px;
  --rx-cell-w: 40px;
...
#roster-admin-root .rx-wrap {
  width: 100% !important; max-width: 100% !important;
  margin: 0 !important; padding: 0 16px 32px !important;
}
...
#roster-admin-root .rx-kpis {
  ...
  animation: rx-fade-in .30s ease both !important;
}
#roster-admin-root .rx-kpi {
  ...
  gap: 12px !important; position: relative !important;
...
#roster-admin-root .rx-kpi::before {
  ...
  height: 3px !important; border-radius: 14px 14px 0 0 !important;
...
#roster-admin-root .rx-kpi-icon {
  ...
  background: var(--rx-surface2) !important;
...
#roster-admin-root .rx-kpi-lbl {
  font-size: 9.5px !important; font-weight: 700 !important;
  color: var(--rx-ink3) !important; letter-spacing: .06em !important;
...
#roster-admin-root .rx-kpi-val {
  ...
  letter-spacing: -0.04em !important; color: var(--rx-ink) !important;
  line-height: 1 !important; margin: 0 0 4px !important;
}
#roster-admin-root .rx-kpi-sub {
  font-size: 10px !important; color: var(--rx-ink3) !important;
  font-weight: 400 !important; line-height: 1.3 !important;
  white-space: nowrap !important; overflow: hidden !important; text-overflow: ellipsis !important;
}
#roster-admin-root .rx-kpi-bar {
  height: 3px !important; border-radius: 99px !important;
  background: var(--rx-border2) !important; margin-top: 10px !important; overflow: hidden !important;
}
#roster-admin-root .rx-kpi-bar-fill {
  height: 100% !important; border-radius: 99px !important;
  background: linear-gradient(90deg,var(--rx-accent),#FB923C) !important;
...
#roster-admin-root .rx-toolbar {
  ...
  animation: rx-fade-in .32s ease .03s both !important;
}
#roster-admin-root .rx-month-display {
  ...
  padding: 0 10px !important; height: 32px !important; min-width: 130px !important;
}
#roster-admin-root .rx-month-display span {
  font-size: 13px !important; font-weight: 700 !important;
  min-width: 100px !important; text-align: center !important;
  letter-spacing: -0.01em !important; color: #fff !important;
}
#roster-admin-root .rx-month-display input[type=month] {
  position: absolute !important; opacity: 0 !important;
  width: 100% !important; height: 100% !important; cursor: pointer !important; left: 0 !important;
}
#roster-admin-root .rx-icon-btn {
  width: 32px !important; height: 32px !important;
  border-radius: var(--rx-radius-sm) !important;
  border: 1px solid var(--rx-border) !important;
  background: var(--rx-surface) !important; color: var(--rx-ink3) !important;
  cursor: pointer !important; display: grid !important; place-items: center !important;
  font-size: 14px !important; transition: all .15s ease !important; flex-shrink: 0 !important;
}
#roster-admin-root .rx-icon-btn:hover {
  background: var(--rx-accent-light) !important;
  border-color: var(--rx-accent) !important; color: var(--rx-accent) !important;
...
#roster-admin-root .rx-pill {
  ...
  border-radius: var(--rx-radius-sm) !important;
  border: 1px solid var(--rx-border) !important;
  background: var(--rx-surface) !important; color: var(--rx-ink2) !important;
  ...
  gap: 6px !important; transition: all .14s ease !important; white-space: nowrap !important;
}
#roster-admin-root .rx-pill:hover { background: var(--rx-surface2) !important; }
#roster-admin-root .rx-pill-primary {
  background: var(--rx-accent) !important; border-color: var(--rx-accent) !important;
  color: #fff !important; font-weight: 600 !important;
  box-shadow: 0 2px 8px rgba(249,115,22,.30) !important;
}
#roster-admin-root .rx-pill-primary:hover {
  filter: brightness(1.06) !important;
  box-shadow: 0 4px 12px rgba(249,115,22,.38) !important;
}
#roster-admin-root .rx-search {
  display: flex !important; align-items: center !important;
  gap: 8px !important; height: 32px !important; padding: 0 12px !important;
  border: 1px solid var(--rx-border) !important;
  border-radius: var(--rx-radius-sm) !important;
  background: var(--rx-surface) !important; flex: 1 !important; min-width: 180px !important;
  transition: border-color .15s, box-shadow .15s !important;
}
#roster-admin-root .rx-search:focus-within {
...
#roster-admin-root .rx-search input {
  ...
  font-family: 'Poppins',sans-serif !important; font-size: 12.5px !important;
  width: 100% !important; color: var(--rx-ink) !important; background: transparent !important;
}
#roster-admin-root .rx-search input::placeholder { color: var(--rx-ink4) !important; }
#roster-admin-root .rx-switch {
  display: inline-flex !important; align-items: center !important;
  gap: 6px !important; font-size: 11.5px !important; color: var(--rx-ink2) !important;
  cursor: pointer !important; padding: 4px 10px !important;
  background: var(--rx-surface2) !important; border-radius: 99px !important;
  border: 1px solid var(--rx-border) !important; user-select: none !important;
}
...
#roster-admin-root .rx-filter-bar {
  display: flex !important; align-items: center !important;
  gap: 0 !important; padding: 7px 14px !important;
  background: var(--rx-surface) !important;
  border: 1px solid var(--rx-border) !important;
  border-radius: var(--rx-radius) !important;
  flex-wrap: wrap !important; row-gap: 5px !important;
  margin-bottom: 8px !important;
  box-shadow: var(--rx-shadow-xs) !important;
  animation: rx-fade-in .34s ease .06s both !important;
}
...
#roster-admin-root .rx-filter-label {
  font-size: 9px !important; font-weight: 800 !important;
  color: var(--rx-ink3) !important; text-transform: uppercase !important;
  letter-spacing: .08em !important; display: inline-flex !important;
  align-items: center !important; gap: 3px !important;
  white-space: nowrap !important; margin-right: 5px !important;
}
#roster-admin-root .rx-filter-sep {
  width: 1px !important; height: 20px !important;
  background: var(--rx-border) !important; margin: 0 10px !important; flex-shrink: 0 !important;
}
#roster-admin-root .rx-filter-chip {
  display: inline-flex !important; align-items: center !important;
  gap: 5px !important; padding: 3px 11px !important;
  border-radius: 99px !important; font-size: 11px !important; font-weight: 500 !important;
  border: 1.5px solid transparent !important;
  background: var(--rx-surface2) !important; color: var(--rx-ink2) !important;
  cursor: pointer !important; transition: all .14s ease !important;
  font-family: 'Poppins',sans-serif !important;
}
#roster-admin-root .rx-filter-chip:hover {
  border-color: var(--rx-accent) !important; color: var(--rx-accent) !important;
  background: var(--rx-accent-light) !important; transform: translateY(-1px) !important;
}
#roster-admin-root .rx-filter-chip.active {
  background: var(--rx-accent) !important; border-color: var(--rx-accent) !important;
  color: #fff !important; font-weight: 600 !important;
  box-shadow: 0 2px 6px var(--rx-accent-glow) !important;
}
#roster-admin-root .rx-fc-dot {
  width: 7px !important; height: 7px !important; border-radius: 50% !important;
  display: inline-block !important; flex-shrink: 0 !important;
}
#roster-admin-root .rx-filter-clear {
  margin-left: auto !important; display: inline-flex !important; align-items: center !important;
  gap: 4px !important; padding: 3px 11px !important; border-radius: 99px !important;
  font-size: 10.5px !important; font-weight: 600 !important;
  border: 1.5px solid rgba(239,68,68,.25) !important;
  background: rgba(239,68,68,.06) !important; color: #DC2626 !important;
  cursor: pointer !important; font-family: 'Poppins',sans-serif !important; transition: all .14s !important;
}
#roster-admin-root .rx-filter-clear:hover {
  background: rgba(239,68,68,.12) !important; border-color: #DC2626 !important;
}

/* === VIEW TABS — Segmented control === */
#roster-admin-root .rx-view-tabs {
  display: flex !important; align-items: center !important;
  gap: 0 !important; margin-bottom: 8px !important;
  background: var(--rx-surface) !important;
  border: 1px solid var(--rx-border) !important;
  border-radius: var(--rx-radius) !important;
  padding: 4px !important; width: fit-content !important;
  box-shadow: var(--rx-shadow-xs) !important;
  animation: rx-fade-in .34s ease .09s both !important;
}
#roster-admin-root .rx-view-tab {
  display: inline-flex !important; align-items: center !important;
  gap: 6px !important; padding: 6px 16px !important;
  border-radius: 10px !important; font-size: 12.5px !important; font-weight: 500 !important;
  border: none !important; background: transparent !important;
  color: var(--rx-ink3) !important; cursor: pointer !important;
  transition: all .18s ease !important; font-family: 'Poppins',sans-serif !important;
}
#roster-admin-root .rx-view-tab:hover { color: var(--rx-ink2) !important; background: var(--rx-surface2) !important; }
#roster-admin-root .rx-view-tab.active {
  background: var(--rx-accent) !important; color: #fff !important; font-weight: 600 !important;
  box-shadow: 0 2px 8px var(--rx-accent-glow) !important;
}
#roster-admin-root .rx-view-count {
  margin-left: auto !important; font-size: 11px !important;
  font-weight: 500 !important; color: var(--rx-ink3) !important; padding-left: 12px !important;
}

/* === LEGEND === */
#roster-admin-root .rx-legend {
  display: flex !important; flex-wrap: wrap !important;
  gap: 4px 10px !important; padding: 5px 2px 4px !important; align-items: center !important;
  animation: rx-fade-in .34s ease .12s both !important;
}
#roster-admin-root .rx-lg {
  display: inline-flex !important; align-items: center !important;
  gap: 6px !important; font-size: 11px !important;
  color: var(--rx-ink2) !important; font-weight: 400 !important;
}
#roster-admin-root .rx-lg-code {
  font-weight: 800 !important; font-size: 8.5px !important;
  padding: 2px 6px !important; border-radius: 5px !important;
  letter-spacing: .02em !important;
}
#roster-admin-root .rx-lg-name { font-size: 11px !important; color: var(--rx-ink2) !important; }
#roster-admin-root .rx-lg-tip {
  margin-left: auto !important; font-size: 9.5px !important;
  color: var(--rx-ink4) !important; font-style: italic !important;
}
...
#roster-admin-root .rx-grid-wrap {
  ...
  margin-top: 0 !important; scroll-behavior: smooth !important;
  animation: rx-fade-in .38s ease .15s both !important;
}
#roster-admin-root .rx-grid-wrap::-webkit-scrollbar { width: 6px !important; height: 6px !important; }
#roster-admin-root .rx-grid-wrap::-webkit-scrollbar-track { background: transparent !important; }
#roster-admin-root .rx-grid-wrap::-webkit-scrollbar-thumb { background: #CBD5E1 !important; border-radius: 99px !important; }
#roster-admin-root .rx-grid-wrap::-webkit-scrollbar-thumb:hover { background: #94A3B8 !important; }
...
#roster-admin-root .rx-grid thead .rx-th {
  ...
  height: 48px !important; vertical-align: middle !important; padding: 0 !important;
}
#roster-admin-root .rx-th-name {
  position: sticky !important; left: 0 !important; z-index: 7 !important;
  background: var(--rx-surface) !important; text-align: left !important; padding-left: 20px !important;
  min-width: var(--rx-agent-w) !important; width: var(--rx-agent-w) !important;
  border-right: 1px solid var(--rx-border) !important; border-bottom: 2px solid var(--rx-border) !important;
  font-size: 10.5px !important; font-weight: 700 !important; color: var(--rx-ink2) !important;
...
#roster-admin-root .rx-th-day.rx-week-end { border-left: 1px solid var(--rx-border2) !important; }
#roster-admin-root .rx-th-day.rx-t { background: rgba(249,115,22,.04) !important; }
...
#roster-admin-root .rx-th-dow {
  font-size: 9px !important; font-weight: 600 !important; color: var(--rx-ink3) !important;
  display: block !important; line-height: 1 !important;
  text-transform: uppercase !important; letter-spacing: .04em !important;
}
#roster-admin-root .rx-th-num {
  font-size: 13px !important; font-weight: 700 !important; color: var(--rx-ink2) !important;
...
#roster-admin-root .rx-th-att {
  ...
  background: var(--rx-surface) !important;
  border-left: 1px solid var(--rx-border) !important; border-bottom: 2px solid var(--rx-border) !important;
  width: var(--rx-att-w) !important; min-width: var(--rx-att-w) !important;
  font-size: 10px !important; font-weight: 700 !important; color: var(--rx-ink2) !important;
  letter-spacing: .05em !important; text-transform: uppercase !important; text-align: center !important;
}

/* Rows */
#roster-admin-root .rx-row {
  height: var(--rx-row-h) !important; background: var(--rx-surface) !important; transition: background .10s !important;
}
...
#roster-admin-root .rx-row:hover { background: rgba(249,115,22,.025) !important; }
#roster-admin-root .rx-row-relieved { opacity: .45 !important; }
#roster-admin-root .rx-no-rows {
  padding: 60px 20px !important; text-align: center !important;
  color: var(--rx-ink3) !important; font-size: 13px !important;
}
...
#roster-admin-root .rx-td-name {
  ...
  padding: 0 0 0 20px !important; vertical-align: middle !important;
  min-width: var(--rx-agent-w) !important; width: var(--rx-agent-w) !important;
  cursor: pointer !important; transition: background .10s !important;
}
#roster-admin-root .rx-row:hover .rx-td-name {
  background: rgba(249,115,22,.025) !important;
...
#roster-admin-root .rx-row:nth-child(even):hover .rx-td-name { background: rgba(249,115,22,.025) !important; }
...
#roster-admin-root .rx-meta {
  font-size: 9.5px !important; color: var(--rx-ink3) !important;
  margin-top: 1px !important; display: block !important;
  white-space: nowrap !important; overflow: hidden !important;
  text-overflow: ellipsis !important; max-width: 210px !important; font-weight: 400 !important;
}
...
#roster-admin-root .rx-cell.rx-w { background: rgba(248,250,255,.7) !important; }
...
#roster-admin-root .rx-day-num {
  ...
  transition: transform .20s cubic-bezier(.34,1.56,.64,1), box-shadow .20s ease !important;
  position: relative !important;
}
#roster-admin-root .rx-day-empty {
  background: transparent !important; color: var(--rx-ink4) !important;
  font-weight: 500 !important; font-size: 12px !important;
}
#roster-admin-root .rx-cell.rx-w .rx-day-empty { color: var(--rx-border) !important; }
...
#roster-admin-root .rx-cell.rx-t .rx-day-num:not(.rx-day-empty) {
  box-shadow: 0 0 0 2.5px var(--rx-accent), 0 0 0 4px var(--rx-accent-glow) !important;
}
#roster-admin-root .rx-cell:hover .rx-day-num {
  transform: scale(1.18) !important;
  box-shadow: 0 0 0 3px var(--rx-accent-glow), 0 4px 14px rgba(249,115,22,.28) !important;
  z-index: 3 !important;
}

/* Status colors */
#roster-admin-root .rx-st-present .rx-day-num  { background: #059669 !important; color: #fff !important; }
#roster-admin-root .rx-st-wfh     .rx-day-num  { background: #7C3AED !important; color: #fff !important; }
#roster-admin-root .rx-st-on_duty .rx-day-num  { background: #F97316 !important; color: #fff !important; }
#roster-admin-root .rx-st-off     .rx-day-num  { background: #64748B !important; color: #fff !important; }
#roster-admin-root .rx-st-holiday .rx-day-num  { background: #0891B2 !important; color: #fff !important; }
#roster-admin-root .rx-st-pl      .rx-day-num  { background: #2563EB !important; color: #fff !important; }
#roster-admin-root .rx-st-hd_pl   .rx-day-num  { background: #93C5FD !important; color: #1E40AF !important; }
...
#roster-admin-root .rx-st-sl      .rx-day-num  { background: #DC2626 !important; color: #fff !important; }
#roster-admin-root .rx-st-hd_sl   .rx-day-num  { background: #FCA5A5 !important; color: #7F1D1D !important; }
#roster-admin-root .rx-st-ncns    .rx-day-num  {
  background: #991B1B !important; color: #fff !important;
  box-shadow: 0 0 0 3px rgba(153,27,27,.20), 0 2px 10px rgba(153,27,27,.40) !important;
}
#roster-admin-root .rx-st-absent  .rx-day-num  { background: #1E293B !important; color: #fff !important; }
...
#roster-admin-root .rx-td-att {
  ...
  vertical-align: middle !important; transition: background .10s !important;
}
#roster-admin-root .rx-row:nth-child(even) .rx-td-att { background: #FAFBFD !important; }
#roster-admin-root .rx-row:hover .rx-td-att { background: rgba(249,115,22,.025) !important; }
...
#roster-admin-root .rx-att-bar {
  ...
  background: var(--rx-border2) !important; overflow: hidden !important; width: 100% !important;
}
#roster-admin-root .rx-att-bar i {
  display: block !important; height: 100% !important; border-radius: 99px !important; transition: width .4s ease !important;
}
...
#roster-admin-root .rx-bulk-bar {
  background: var(--rx-navy) !important; border-radius: var(--rx-radius) !important;
  padding: 8px 14px !important;
  box-shadow: 0 16px 48px rgba(15,23,42,.25), 0 4px 12px rgba(15,23,42,.15) !important;
  align-items: center !important; gap: 10px !important; flex-wrap: nowrap !important;
  min-height: 48px !important; border: none !important;
}
#roster-admin-root .rx-bulk-bar[style*="display: flex"],
#roster-admin-root .rx-bulk-bar[style*="display:flex"] { display: flex !important; }
#roster-admin-root .rx-bulk-count {
  color: #fff !important; font-size: 11.5px !important; font-weight: 700 !important;
  white-space: nowrap !important; background: rgba(255,255,255,.12) !important;
  padding: 4px 12px !important; border-radius: 99px !important;
  border: 1px solid rgba(255,255,255,.15) !important;
}
#roster-admin-root .rx-bulk-sel, #roster-admin-root .rx-bulk-date {
  height: 30px !important; font-size: 11.5px !important; padding: 0 10px !important;
  border-radius: 8px !important; border: 1px solid rgba(255,255,255,.20) !important;
  background: rgba(255,255,255,.08) !important; color: #fff !important;
  font-family: 'Poppins',sans-serif !important;
}
#roster-admin-root .rx-bulk-date { max-width: 140px !important; }
#roster-admin-root .rx-bulk-btn {
  height: 30px !important; padding: 0 14px !important; border-radius: 8px !important;
  border: 1px solid rgba(255,255,255,.20) !important; background: rgba(255,255,255,.10) !important;
  color: #fff !important; font-size: 11.5px !important; font-weight: 600 !important;
  cursor: pointer !important; font-family: 'Poppins',sans-serif !important;
  white-space: nowrap !important; transition: all .14s !important;
}
#roster-admin-root .rx-bulk-btn:hover { background: rgba(255,255,255,.20) !important; }
#roster-admin-root .rx-bulk-btn-primary {
  background: var(--rx-accent) !important; border-color: var(--rx-accent) !important;
  box-shadow: 0 2px 8px rgba(249,115,22,.40) !important;
}
#roster-admin-root .rx-bulk-btn-danger {
  background: rgba(220,38,38,.25) !important; border-color: rgba(220,38,38,.45) !important;
}
#roster-admin-root .rx-bulk-sep {
  width: 1px !important; height: 20px !important;
  background: rgba(255,255,255,.18) !important; flex-shrink: 0 !important;
}

/* === QUICK-PICK POPUP === */
#roster-admin-root .rx-qp {
  background: var(--rx-surface) !important; border: 1px solid var(--rx-border) !important;
  border-radius: 16px !important; box-shadow: var(--rx-shadow-lg) !important;
  animation: rx-qp-enter .18s cubic-bezier(.34,1.56,.64,1) both !important;
  min-width: 340px !important; padding: 0 !important;
  flex-direction: column !important; align-items: stretch !important;
}
@keyframes rx-qp-enter {
  from { opacity:0; transform: scale(.90) translateY(-8px); }
  to   { opacity:1; transform: scale(1) translateY(0); }
}
#roster-admin-root .rx-qp-header {
  display: flex !important; align-items: center !important;
  justify-content: space-between !important;
  padding: 10px 14px 8px !important; border-bottom: 1px solid var(--rx-border2) !important;
  background: var(--rx-surface2) !important; border-radius: 16px 16px 0 0 !important;
}
#roster-admin-root .rx-qp-title {
  font-size: 10px !important; font-weight: 800 !important;
  color: var(--rx-ink2) !important; text-transform: uppercase !important; letter-spacing: .10em !important;
}
#roster-admin-root .rx-qp-body {
  display: flex !important; flex-direction: row !important; padding: 12px !important; gap: 0 !important;
}
#roster-admin-root .rx-qp-group { display: flex !important; flex-direction: column !important; gap: 6px !important; }
#roster-admin-root .rx-qp-glabel {
  font-size: 8.5px !important; font-weight: 800 !important; color: var(--rx-ink3) !important;
  text-transform: uppercase !important; letter-spacing: .10em !important; padding: 0 2px 3px !important;
}
#roster-admin-root .rx-qp-grow { display: flex !important; flex-wrap: wrap !important; gap: 5px !important; }
#roster-admin-root .rx-qp-vsep {
  width: 1px !important; background: var(--rx-border2) !important;
  align-self: stretch !important; margin: 0 10px !important;
}
#roster-admin-root .rx-qp-btn {
  display: flex !important; flex-direction: column !important;
  align-items: center !important; gap: 3px !important; padding: 7px 8px !important;
  border-radius: 10px !important; border: 1.5px solid var(--rx-border2) !important;
  background: var(--rx-surface2) !important; cursor: pointer !important;
  min-width: 46px !important; font-family: 'Poppins',sans-serif !important;
  transition: all .15s cubic-bezier(.34,1.56,.64,1) !important;
}
#roster-admin-root .rx-qp-btn:hover {
  transform: translateY(-3px) scale(1.06) !important;
  box-shadow: 0 6px 16px rgba(0,0,0,.12) !important;
  border-color: transparent !important;
}
#roster-admin-root .rx-qp-code {
  font-weight: 800 !important; font-size: 9.5px !important;
  padding: 2px 6px !important; border-radius: 6px !important; display: block !important;
}
#roster-admin-root .rx-qp-lbl {
  font-size: 7.5px !important; color: var(--rx-ink2) !important;
  white-space: nowrap !important; text-align: center !important; font-weight: 500 !important;
}
#roster-admin-root .rx-qp-clear {
  display: flex !important; align-items: center !important; justify-content: center !important;
  width: 26px !important; height: 26px !important; border-radius: 8px !important;
  border: 1.5px solid rgba(220,38,38,.30) !important; background: rgba(220,38,38,.06) !important;
  cursor: pointer !important; color: #DC2626 !important; transition: all .14s !important; font-size: 13px !important;
}
#roster-admin-root .rx-qp-clear:hover {
  background: rgba(220,38,38,.12) !important; border-color: #DC2626 !important; transform: scale(1.08) !important;
}
